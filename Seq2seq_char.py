...
with open('/Users/owen/BIGDATA/Data/seq2seq/letters_source.txt', 'r', encoding='utf-8') as f:
    source_data = f.read()

with open('/Users/owen/BIGDATA/Data/seq2seq/letters_target.txt', 'r', encoding='utf-8') as f:
    target_data = f.read()
